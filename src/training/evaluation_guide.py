...
def show_evaluation_usage():
    ...
    print("   Command: python src/training/quick_evaluate.py")
    print("   Features:")
    ...
    print("   • MLflow tracking for evaluation metrics")
    
    print("\n2️⃣ Comprehensive Evaluation (Full analysis)")
    print("   Command: python src/training/evaluate_models.py --models sae rbm --visualize")
    print("   Features:")
    ...
    print("   • MLflow tracking with detailed experiment logging")
    
    print("\n3️⃣ Individual Model Evaluation")
    print("   SAE only: python src/training/evaluate_models.py --models sae")
    print("   RBM only: python src/training/evaluate_models.py --models rbm")
    
    print("\n🔬 MLflow Integration:")
    print("="*25)
    print("   Both evaluation scripts automatically log to MLflow:")
    print("   • Experiments: 'model_evaluation', 'quick_evaluation'")
    print("   • Metrics: RMSE, MAE, R², Binary Accuracy, etc.")
    print("   • Parameters: Architecture details, hyperparameters")
    print("   • View results: mlflow ui (from project root)")
    print("   • Compare runs across different model versions")
